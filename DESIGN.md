...
For transaction categorization, the category label, source (`Suggested by AI`, `Rule`, or
`Manual`), and pending/failed status are secondary text signals. Always render those cues as
