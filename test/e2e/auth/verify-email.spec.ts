...
test.describe('Email Verification - Onboarding flow', () => {
  ...
  test.describe('Verified authenticated access to /verify-email with invalid search params', () => {
  ...
  test.describe('Unverified authenticated access to /verify-email with invalid search params', () => {
    for (const testCase of invalidSearchParamsTestCases) {
  ...
  test.describe('Unauthenticated access to /verify-email with invalid search params', () => {
    for (const testCase of invalidSearchParamsTestCases) {
